						...
						<aside>
							<div class="chose">
								<div class="car-sec">
									...
									<div class="star-box">
										<span><small><?=$data->model_name?></small></span>
									</div>
								</div>
						...
						<div class="tab-article" style="display:block;">
							<form action="/process-payment?id=<?=$_GET['id']?>" method="post">
								<ul class="form-two clearfix">
									...
									<li><input type="text" name="time" placeholder="Pickup Time"></li>
								</ul>
								...
								<div class="pickupbox">
									...
									<ul class="form-two clearfix">
										...
										<li><input type="text" name="Pickup Address" placeholder="Pickup Address"></li>
										<li><input type="password" name="mobile" placeholder="Password"></li>
										<li><input type="password" name="mobile" placeholder="Confirm Password"></li>
									</ul>
								</div>

								<div class="checkbox">
							    	<input type="checkbox" name="checkboxa" id="checkboxb">
